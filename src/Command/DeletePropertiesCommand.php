 ...
 * )
 */
class DeletePropertiesCommand extends Command
{
  protected function configure(): void
  {
    $this->setName('vneml:delete:props')
      ->setDescription('Delete all prop terms added by the import.');
  }
