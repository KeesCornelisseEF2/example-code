 ...
 * )
 */
class DeleteOverviewPagesCommand extends Command
{
  protected function configure(): void
  {
    $this->setName('vneml:delete:overview-pages')
      ->setDescription('Delete all overview pages added by the import.');
  }
